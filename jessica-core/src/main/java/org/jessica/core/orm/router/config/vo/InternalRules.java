package org.jessica.core.orm.router.config.vo;
...
public class InternalRules {
	...
	public static void main(String[] args) {
		...
		r1.setNamespace("com.alibaba.orm.entity.Follower");
		r1.setShards("partition1");
		rList.add(r1);
		InternalRule r2 = new InternalRule();
		r2.setSqlmap("com.alibaba.orm.entity.Follower.create");
		r2.setShards("p1, p2");
		rList.add(r2);
		InternalRule r3 = new InternalRule();
		r3.setSqlmap("com.alibaba.orm.entity.Follower.create");
		r3.setShardingExpression("id>10000 and id< 20000");
		r3.setShards("p1, p2");
		rList.add(r3);
		InternalRule r4 = new InternalRule();
		r4.setNamespace("com.alibaba.orm.entity.Follower");
