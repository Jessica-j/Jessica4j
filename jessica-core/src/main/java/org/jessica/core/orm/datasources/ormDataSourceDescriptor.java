...
public class ormDataSourceDescriptor {
	/**
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ormDataSourceDescriptor other = (ormDataSourceDescriptor) obj;
		if (identity == null) {
	...
	public String toString() {
		return "ormDataSourceDescriptor [identity=" + identity + ", poolSize=" + poolSize + ", standbyDataSource=" + standbyDataSource + ", standbyDetectorDataSource=" + standbyDetectorDataSource + ", targetDataSource=" + targetDataSource + ", targetDetectorDataSource=" + targetDetectorDataSource
				+ "]";
	}
